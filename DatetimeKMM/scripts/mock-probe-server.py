...
Returns a configurable status code per path. The special path /429once returns
429 on the first request and 200 thereafter, to exercise bounded retry/backoff.

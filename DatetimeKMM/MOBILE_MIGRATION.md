...
- The Android host computes
  `TimeZone.getDefault().getOffset(nowMillis) / 60_000`, then injects
  `localOffsetMinutes`, `todayEpochDay`, and `nowEpochMillis` into page data.

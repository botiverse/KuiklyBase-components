...
internal object AndroidCurlJniBridge : AndroidCurlNativeBridge {
    ...
    override suspend fun execute(request: AndroidCurlNativeRequest): CurlNativeResponse {
        ...
        return try {
            ...
            if (error !is UnsatisfiedLinkError && error !is NoSuchMethodError) {
                throw error
            }
    ...
    private suspend fun perform(
        ...
        runCatching {
            nativePerform(
                ...
                headerValues = values,
                timeoutMillis = request.timeoutMillis,
                streamConnectTimeoutMillis = request.streamConnectTimeoutMillis,
                streamResponseHeadersTimeoutMillis = request.streamResponseHeadersTimeoutMillis,
                streamIdleTimeoutMillis = request.streamIdleTimeoutMillis,
    ...
    private external fun nativePerform(
        ...
        timeoutMillis: Long,
        streamConnectTimeoutMillis: Long,
        streamResponseHeadersTimeoutMillis: Long,

...
class PlatformNetworkEnginesTest {
    @Test
    fun phaseOneKeepsKtorDefaultAndCurlUnavailableOnAndroid() {
        assertEquals(NetworkTransportEngine.KTOR, platformDefaultNetworkTransportEngine)
        assertNotNull(resolvePlatformNetworkEngine(NetworkTransportEngine.KTOR))
